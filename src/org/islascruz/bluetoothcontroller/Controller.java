package org.islascruz.bluetoothcontroller;
...
public class Controller extends Activity implements View.OnClickListener {
	...
	Button next, prev, button1, f5, esc;
	String text;
	...
	public void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.main);
		f5=(Button)findViewById(R.id.ffive);
	...
	public void setLabel(View button) {
